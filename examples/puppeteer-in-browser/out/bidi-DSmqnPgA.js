...
let Navigation = (() => {
    ...
    return class Navigation extends _classSuper {
        ...
        #request = (__runInitializers$d(this, _instanceExtraInitializers), void 0);
        #navigation;
        #browsingContext;
...
let Realm = (() => {
    ...
    return class Realm extends _classSuper {
        ...
        #reason = (__runInitializers$c(this, _instanceExtraInitializers), void 0);
        disposables = new DisposableStack();
        id;
        origin;
        executionContextId;
...
let Request = (() => {
    ...
    return class Request extends _classSuper {
        ...
        #error = (__runInitializers$b(this, _instanceExtraInitializers), void 0);
        #redirect;
        #response;
        #browsingContext;
        #disposables = new DisposableStack();
...
let UserPrompt = (() => {
    ...
    return class UserPrompt extends _classSuper {
        ...
        #reason = (__runInitializers$a(this, _instanceExtraInitializers), void 0);
        #result;
        #disposables = new DisposableStack();
        browsingContext;
        info;
...
let BrowsingContext = (() => {
    ...
    return class BrowsingContext extends _classSuper {
        ...
        #navigation = (__runInitializers$9(this, _instanceExtraInitializers), void 0);
        #reason;
        #url;
        #children = new Map();
        #disposables = new DisposableStack();
...
let UserContext = (() => {
    ...
    return class UserContext extends _classSuper {
        ...
        #reason = (__runInitializers$8(this, _instanceExtraInitializers), void 0);
...
class ExposeableFunction {
    ...
    #handleMessage = async (params) => {
        ...
        try {
            ...
            const argsHandle = __addDisposableResource$3(env_1, await dataHandle.evaluateHandle(([, , args]) => {
                return args;
            }), false);
...
let BidiHTTPResponse = (() => {
    ...
    return class BidiHTTPResponse extends _classSuper {
        ...
        #data = (__runInitializers$6(this, _instanceExtraInitializers), void 0);
        #request;
...
let BidiFrame = (() => {
    ...
    return class BidiFrame extends _classSuper {
        ...
        #parent = (__runInitializers$5(this, _instanceExtraInitializers), void 0);
        browsingContext;
        #frames = new WeakMap();
        realms;
        _id;
...
let BidiPage = (() => {
    ...
    return class BidiPage extends _classSuper {
        static {
            ...
            __esDecorate$4(this, null, _trustedEmitter_decorators, { kind: "accessor", name: "trustedEmitter", static: false, private: false, access: { has: obj => "trustedEmitter" in obj, get: obj => obj.trustedEmitter, set: (obj, value) => { obj.trustedEmitter = value; } }, metadata: _metadata }, _trustedEmitter_initializers, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        ...
        #trustedEmitter_accessor_storage = (__runInitializers$4(this, _instanceExtraInitializers), __runInitializers$4(this, _trustedEmitter_initializers, new EventEmitter()));
        ...
        async focusedFrame() {
            const env_1 = { stack: [], error: void 0, hasError: false };
            try {
                const handle = __addDisposableResource$1(env_1, (await this.mainFrame()
                    .isolatedRealm()
                    .evaluateHandle(() => {
                    let win = window;
...
let BidiBrowserContext = (() => {
    ...
    return class BidiBrowserContext extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _trustedEmitter_decorators = [bubble()];
            __esDecorate$3(this, null, _trustedEmitter_decorators, { kind: "accessor", name: "trustedEmitter", static: false, private: false, access: { has: obj => "trustedEmitter" in obj, get: obj => obj.trustedEmitter, set: (obj, value) => { obj.trustedEmitter = value; } }, metadata: _metadata }, _trustedEmitter_initializers, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        ...
        #trustedEmitter_accessor_storage = (__runInitializers$3(this, _instanceExtraInitializers), __runInitializers$3(this, _trustedEmitter_initializers, new EventEmitter()));
        get trustedEmitter() { return this.#trustedEmitter_accessor_storage; }
        set trustedEmitter(value) { this.#trustedEmitter_accessor_storage = value; }
        #browser;
        #defaultViewport;
...
let Session = (() => {
    ...
    return class Session extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate$1(this, null, _connection_decorators, { kind: "accessor", name: "connection", static: false, private: false, access: { has: obj => "connection" in obj, get: obj => obj.connection, set: (obj, value) => { obj.connection = value; } }, metadata: _metadata }, _connection_initializers, _instanceExtraInitializers);
